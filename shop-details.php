    ...
    <div class="product__details__pic">
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- // Cách đổ dữ liệu đối với While  ^_^ @hoangthanh21it173 -->
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                <div class="product__thumb__pic set-bg" data-setbg="img/product/' . $product['img'] . '"></div>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-4" role="tab">
                                <div class="product__thumb__pic set-bg" data-setbg="img/product/' . $product['img'] . '">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tabs-4" role="tabpanel">
                            <div class="product__details__pic__item">
                                ...
                                <a href="https://www.youtube.com/watch?v=B2PTm53oPrU&ab_channel=Shanographer" class="video-popup"><i class="fa fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                </div>';
                ...
                <div class="col-lg-8">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__cart__option">
                            ...
                            <button class="primary-btn" onclick="addToCart(<?= $id ?>)">add to cart</button>
                        </div>
